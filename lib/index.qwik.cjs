...
const MenuItemList = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  ...
  return /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, {
    ...
    }, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "cH_0"), 1, "cH_1") : null
  }, 1, "cH_2");
...
const Tabs = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  ...
  qwik.useContextProvider(TabsContext, store);
  return /* @__PURE__ */ qwik._jsxQ("div", null, null, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "LW_0"), 1, "LW_1");
}, "Tabs_component_aST30a5hXcI"));
/* @__PURE__ */ qwik._jsxC(Tabs, {
  children: [
    /* @__PURE__ */ qwik._jsxC(TabsItemList, {
      children: [
        /* @__PURE__ */ qwik._jsxC(TabsItem, null, 3, "LW_2"),
        /* @__PURE__ */ qwik._jsxC(TabsItem, null, 3, "LW_3"),
        /* @__PURE__ */ qwik._jsxC(TabsItem, null, 3, "LW_4")
      ]
    }, 1, "LW_5"),
    /* @__PURE__ */ qwik._jsxC(TabsPanels, {
      children: [
        /* @__PURE__ */ qwik._jsxC(TabPanel, {
          expanded: true,
          [qwik._IMMUTABLE]: {
            expanded: qwik._IMMUTABLE
          }
        }, 3, "LW_6"),
        /* @__PURE__ */ qwik._jsxC(TabPanel, null, 3, "LW_7"),
        /* @__PURE__ */ qwik._jsxC(TabPanel, null, 3, "LW_8"),
        /* @__PURE__ */ qwik._jsxC(TabPanel, null, 3, "LW_9")
      ]
    }, 1, "LW_10")
  ]
}, 1, "LW_11");
const TabsItem$1 = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  const ref = qwik.useSignal();
  qwik.useContext(TabsContext);
  const toggle = useToggle();
  const expand$ = /* @__PURE__ */ qwik.inlinedQrl((panelId1) => {
  }, "TabsItem_component_expand_ZN8JQVylyJQ");
  qwik.useOn("click", /* @__PURE__ */ qwik.inlinedQrl(async (e) => {
    const [ref2, toggle2] = qwik.useLexicalScope();
    if (e.detail > 0 && e.button === 0)
  ...
  qwik.useOn("keyup", /* @__PURE__ */ qwik.inlinedQrl(async (e) => {
    const [expand$2] = qwik.useLexicalScope();
    switch (e.code) {
      case "Enter":
      case "Space":
        await expand$2();
  ...
  return /* @__PURE__ */ qwik._jsxQ("li", {
    ...
    role: "tab"
  }, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "mh_0"), 1, "mh_1");
}, "TabsItem_component_KQ3MPf1wnJY"));
const TabsItemList$1 = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  qwik.useContext(TabsContext);
  return /* @__PURE__ */ qwik._jsxQ("ul", null, {
    role: "tablist"
  }, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "0P_0"), 1, "0P_1");
...
exports.Tabs = Tabs;
exports.TabsItem = TabsItem$1;
exports.TabsItemList = TabsItemList$1;

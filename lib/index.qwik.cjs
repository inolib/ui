...
const contextId = qwik.createContextId("inolib/ui/contexts/Menu");
...
const Tabs = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  ...
  return /* @__PURE__ */ qwik._jsxQ("div", null, {
    "preventdefault:keydown": true,
    "preventdefault:keyup": true
  }, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "LW_0"), 1, "LW_1");
}, "Tabs_component_aST30a5hXcI"));
const TabsPanels = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  return /* @__PURE__ */ qwik._jsxQ("div", null, null, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "jc_0"), 1, "jc_1");
...
const TabsPanel = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  ...
  return /* @__PURE__ */ qwik._jsxQ("div", {
    ...
    hidden: qwik._fnSignal((p0) => p0.tab !== void 0 ? p0.tab.hidden : void 0, [
      store
    ], "p0.tab!==undefined?p0.tab.hidden:undefined"),
    role: "tabpanel"
  }, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "yo_0"), 1, "yo_1");
...
const TabsItem = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  ...
  qwik.useTaskQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
    const [context2, id2, props2, store2] = qwik.useLexicalScope();
  ...
  qwik.useVisibleTaskQrl(/* @__PURE__ */ qwik.inlinedQrl(({ track }) => {
    const [context2, id2, store2] = qwik.useLexicalScope();
  ...
  return /* @__PURE__ */ qwik._jsxQ("li", null, null, /* @__PURE__ */ qwik._jsxQ("button", {
    ...
    role: "tab",
    tabIndex: qwik._fnSignal((p0, p1) => p1.ref === p0.Focus.focusable ? 0 : -1, [
      context,
      store
    ], "p1.ref===p0.Focus.focusable?0:-1")
  }, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "mh_0"), 0, null), 1, "mh_1");
}, "TabsItem_component_KQ3MPf1wnJY"));
const TabsListItem = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  const context = qwik.useContext(TabsContext);
  const store = qwik.useStore({
    id: nanoid()
  }, {
  ...
  return /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, {
    children: /* @__PURE__ */ qwik._jsxQ("ul", null, {
      ...
      "preventdefault:keyup": true,
      role: "tablist"
    }, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "Lr_0"), 1, null)
  }, 1, "Lr_1");

...
const TabsContext = qwik.createContextId("inolib/ui/contexts/Tabs");
const Tabs = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  const context = {
    Tabs: qwik.useStore({
      tabs: {
        attributes: []
  ...
  qwik.useContextProvider(TabsContext, context);
  return /* @__PURE__ */ qwik._jsxQ("ul", null, null, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "LW_0"), 1, "LW_1");
}, "Tabs_component_aST30a5hXcI"));
const TabsPanels = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  return /* @__PURE__ */ qwik._jsxQ("ul", null, null, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "jc_0"), 1, "jc_1");
}, "TabsPanels_component_0FdzzeplIGI"));
const TabsPanel = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  const context = qwik.useContext(TabsContext);
  const index = context.Tabs.tabs.attributes.findIndex((element) => element.panelId === props.id);
  return /* @__PURE__ */ qwik._jsxQ("div", {
    hidden: qwik._wrapSignal(context.Tabs.tabs.attributes[index], "hidden"),
    "aria-expanded": qwik._wrapSignal(context.Tabs.tabs.attributes[index], "aria-expanded")
  }, null, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "yo_0"), 1, "yo_1");
}, "TabsPanel_component_gsxYsxLe5hI"));
const TabsItem = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  const id = nanoid();
  const context = qwik.useContext(TabsContext);
  const toggle$ = /* @__PURE__ */ qwik.inlinedQrl((selectedIndex) => {
    const [context2] = qwik.useLexicalScope();
  ...
  return /* @__PURE__ */ qwik._jsxQ("li", null, null, /* @__PURE__ */ qwik._jsxQ("button", {
    onClick$: /* @__PURE__ */ qwik.inlinedQrl(async () => {
      const [context2, id2, toggle$2] = qwik.useLexicalScope();
      const index = context2.Tabs.tabs.attributes.findIndex((element) => element.id === id2);
  ...
  }, null, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "mh_0"), 0, null), 1, "mh_1");
}, "TabsItem_component_KQ3MPf1wnJY"));
const TabsListItem = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  return /* @__PURE__ */ qwik._jsxQ("div", null, null, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "Lr_0"), 1, "Lr_1");
...
exports.TabsListItem = TabsListItem;

...
const useComposite = (store) => {
  ...
  const moveFocus$2 = /* @__PURE__ */ qwik.inlinedQrl(async (to) => {
...
const useExpandable = (store) => {
  ...
  const expand$2 = /* @__PURE__ */ qwik.inlinedQrl(() => {
    const [store2] = qwik.useLexicalScope();
...
const TabsItem = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  const ref = qwik.useSignal();
  ...
  return /* @__PURE__ */ qwik._jsxQ("li", null, null, /* @__PURE__ */ qwik._jsxQ("button", null, null, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "mh_0"), 1, null), 1, "mh_1");
}, "TabsItem_component_KQ3MPf1wnJY"));
const TabsItemList = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl(() => {
  qwik.useContext(TabsContext);
  return /* @__PURE__ */ qwik._jsxQ("ul", null, null, /* @__PURE__ */ qwik._jsxC(qwik.Slot, null, 3, "0P_0"), 1, "0P_1");
...
exports.TabsItemList = TabsItemList;

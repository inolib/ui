import { createContextId, componentQrl, inlinedQrl, useStore, useSignal, useContextProvider, useOn, useLexicalScope, useVisibleTaskQrl, _jsxQ, _fnSignal, _jsxC, Slot, useContext, useTaskQrl, _jsxBranch, _wrapSignal } from "@builder.io/qwik";
...
const Tabs = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(() => {
  ...
  return /* @__PURE__ */ _jsxQ("ul", null, null, /* @__PURE__ */ _jsxC(Slot, null, 3, "LW_0"), 1, "LW_1");
}, "Tabs_component_aST30a5hXcI"));
const TabsPanels = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(() => {
  return /* @__PURE__ */ _jsxQ("ul", null, null, /* @__PURE__ */ _jsxC(Slot, null, 3, "jc_0"), 1, "jc_1");
...
const TabsPanel = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  ...
  return /* @__PURE__ */ _jsxQ("div", {
    hidden: _wrapSignal(context.Tabs.tabs.attributes[index], "hidden"),
    "aria-expanded": _wrapSignal(context.Tabs.tabs.attributes[index], "aria-expanded")
  }, null, /* @__PURE__ */ _jsxC(Slot, null, 3, "yo_0"), 1, "yo_1");
...
const TabsItem = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  ...
  useTaskQrl(/* @__PURE__ */ inlinedQrl(() => {
    const [context2, id2, props2] = useLexicalScope();
  ...
  }, null, /* @__PURE__ */ _jsxC(Slot, null, 3, "mh_0"), 0, null), 1, "mh_1");
}, "TabsItem_component_KQ3MPf1wnJY"));
const TabsListItem = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(() => {
  return /* @__PURE__ */ _jsxQ("div", null, null, /* @__PURE__ */ _jsxC(Slot, null, 3, "Lr_0"), 1, "Lr_1");

import { inlinedQrl, useLexicalScope, createContextId, componentQrl, useStore, useSignal, useContextProvider, useOn, _jsxQ, _jsxC, Slot, _fnSignal, _jsxBranch, useContext, useTaskQrl, useVisibleTaskQrl } from "@builder.io/qwik";
...
const Menu = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(() => {
  const store = useStore({
    expanded: false,
    focusable: useSignal(),
    navigables: [],
  ...
  return /* @__PURE__ */ _jsxQ("div", null, {
    role: "menu"
  }, /* @__PURE__ */ _jsxC(Slot, null, 3, "LN_0"), 1, "LN_1");
}, "Menu_component_3Ne0Ocgg3ZU"));
const MenuButton = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(() => {
  const ref = useSignal();
  ...
  return /* @__PURE__ */ _jsxQ("button", {
    ref
  }, null, /* @__PURE__ */ _jsxC(Slot, null, 3, "RP_0"), 1, "RP_1");
}, "MenuButton_component_M9yWhyAuPBM"));
const MenuItem = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(() => {
  return /* @__PURE__ */ _jsxQ("li", null, null, /* @__PURE__ */ _jsxC(Slot, null, 3, "OT_0"), 1, "OT_1");
}, "MenuItem_component_nC7Gp0YL3CE"));
const MenuItemList = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(() => {
  const store = useContext(MenuContext);
  return /* @__PURE__ */ _jsxQ("ul", null, {
    hidden: _fnSignal((p0) => p0.expanded, [
      store
    ], "p0.expanded")
  }, /* @__PURE__ */ _jsxC(Slot, null, 3, "cH_0"), 1, "cH_1");
